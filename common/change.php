...
<!--===============================================================-->
	...
	<body>
		...
		<form name="myForm" id="update" method="POST" enctype="multipart/form-data" action="#">
			...
			<a href="../client/ClientDashboard.php" class="btn col-sm-5 mx-auto d-flex justify-content-center bg-warning mx-auto text-dark" >Go Back </a>
			<?php }?>
			<?php if($_SESSION['type']=='accountant'){?>			
			<a href="../account/AccountantDashboard.php" class="btn col-sm-5 mx-auto d-flex justify-content-center bg-warning mx-auto text-dark" >Go Back </a>
			<?php }?>

			<input type="submit" class="form-control col-sm-5 mx-auto bg-dark text-light" value="Update" name="submit" id="submit">			
